 ...
 */
import { model,IModel,Model,idiom as lang, notify }from 'entcore/entcore';
...
export class EnsCpls extends Model implements IModel{
    ...
    get api() {
        return {
            get: `/viescolaire/evaluations/ListEnseignementComplement`
        }
    }
...
export class EleveEnseignementCpl extends Model implements IModel{
    ...
    get api(){
        return {
            create :`/viescolaire/evaluations/CreateNiveauEnsCpl`,
            update : `/viescolaire/evaluations/UpdateNiveauEnsCpl?id=${this.id}`,
            get :`/viescolaire/evaluations/GetNiveauEnsCpl?idEleve=${this.id_eleve}`
        }
    }
    toJSON(){
        return{
