...
/***/ function(module, exports, __webpack_require__) {
	...
	var vsco_personnel_ctrl_1 = __webpack_require__(3);
	var vsco_acu_personnel_ctrl_1 = __webpack_require__(6);
	entcore_1.ng.controllers.push(vsco_personnel_ctrl_1.viescolaireController);
	entcore_1.ng.controllers.push(vsco_acu_personnel_ctrl_1.acuVieScolaireController);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.viescolaireController = entcore_1.ng.controller('ViescolaireController', [
	    '$scope', 'route', 'model',
	    function ($scope, route, model) {
	        ...
	        route({
	            accueil: function (params) {
	                entcore_1.template.open('main', '../templates/viescolaire/vsco_acu_personnel');
	            }
	        });
	    }
	]);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var entcore_1 = __webpack_require__(2);
	var vsco_personnel_mdl_1 = __webpack_require__(7);
	var moment = __webpack_require__(4);
	exports.acuVieScolaireController = entcore_1.ng.controller('VscoAcuPersonnelController', [
	    '$scope', 'route', 'model',
	    function ($scope, route, model) {
	        $scope.widget = vsco_personnel_mdl_1.vieScolaire.widget;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WAbsSansMotifs = (function (_super) {
	    __extends(WAbsSansMotifs, _super);
	    function WAbsSansMotifs() {
	        var _this = _super.call(this) || this;
	        _this.collection(Evenement);
	        return _this;
	    }
	    WAbsSansMotifs.prototype.sync = function () {
	        var _this = this;
	        entcore_1.http().getJson("/viescolaire/absences/sansmotifs/" + moment(new Date()).format('YYYY-MM-DD') + "/" + moment(new Date()).format('YYYY-MM-DD'))
	            .done(function (data) {
	            _this.evenements.load(data);
	        });
	    };
	    return WAbsSansMotifs;
	}(entcore_1.Model));
	exports.WAbsSansMotifs = WAbsSansMotifs;
	var WAppelsOublies = (function (_super) {
	    __extends(WAppelsOublies, _super);
	    function WAppelsOublies() {
	        var _this = _super.call(this) || this;
	        _this.collection(Appel);
	        return _this;
	    }
	    WAppelsOublies.prototype.sync = function () {
	        var _this = this;
	        entcore_1.http().getJson("/viescolaire/absences/appels/noneffectues/" + moment(new Date()).format('YYYY-MM-DD') + "/" + moment(new Date()).format('YYYY-MM-DD'))
	            .done(function (data) {
	            _this.appels.load(data);
	        });
	    };
	    return WAppelsOublies;
	}(entcore_1.Model));
	exports.WAppelsOublies = WAppelsOublies;
	var WObservations = (function (_super) {
	    __extends(WObservations, _super);
	    function WObservations() {
	        var _this = _super.call(this) || this;
	        _this.collection(Observation);
	        return _this;
	    }
	    WObservations.prototype.sync = function () {
	        var _this = this;
	        entcore_1.http().getJson('/viescolaire/absences/observations/' + moment(new Date()).format('YYYY-MM-DD') + "/" + moment(new Date()).format('YYYY-MM-DD'))
	            .done(function (data) {
	            _this.observations.load(data);
	        });
	    };
	    return WObservations;
	}(entcore_1.Model));
	exports.WObservations = WObservations;
	...
	var VieScolaire = (function (_super) {
	    ...
	    function VieScolaire() {
	        ...
	        _this.widget.WAbsSansMotifs = new WAbsSansMotifs();
	        _this.widget.WAppelsOublies = new WAppelsOublies();
	        _this.widget.WObservations = new WObservations();
	        return _this;
	    }
...
/***/ }
/******/ ]);
//# sourceMappingURL=vsco_personnels.js.map
//# sourceMappingURL=vsco_personnels-a720492913.js.map
