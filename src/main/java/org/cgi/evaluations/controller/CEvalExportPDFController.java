 ...
 */
public class CEvalExportPDFController extends ControllerHelper {
     ...
     */
    private IEvalDevoirService devoirService;
    ...
    private void getDevoirsByMatiere(JsonArray devoirsJson, JsonObject matiereInter) {
        ...
        List<CEvalNoteDevoir> listeNoteDevoirs = new ArrayList<CEvalNoteDevoir>();
        ...
        for (int i = 0; i < devoirsJson.size(); i++) {
            ...
            if(matiereInter.getString("id").equals(devoirJson.getString("idmatiere"))) {
                ...
                CEvalNoteDevoir noteDevoir = new CEvalNoteDevoir(Double.valueOf(devoirJson.getString("note")),
