...
INSERT INTO notes.thematique_bilan_periodique(libelle, code, type_elt_bilan_periodique) VALUES ('Corps, santé, bien-être et sécurité', 'EPI_SAN', 1, false);
INSERT INTO notes.thematique_bilan_periodique(libelle, code, type_elt_bilan_periodique) VALUES ('Culture et création artistiques', 'EPI_ART', 1, false);
INSERT INTO notes.thematique_bilan_periodique(libelle, code, type_elt_bilan_periodique) VALUES ('Transition écologique et développement durable', 'EPI_EDD', 1, false);
INSERT INTO notes.thematique_bilan_periodique(libelle, code, type_elt_bilan_periodique) VALUES ('Information, communication, citoyenneté', 'EPI_EDD', 1, false);
INSERT INTO notes.thematique_bilan_periodique(libelle, code, type_elt_bilan_periodique) VALUES ('Langues et cultures de l''Antiquité', 'EPI_LGA', 1, false);
INSERT INTO notes.thematique_bilan_periodique(libelle, code, type_elt_bilan_periodique) VALUES ('Langues et cultures étrangères ou, le cas échéant, régionales', 'EPI_LGE', 1, false);
INSERT INTO notes.thematique_bilan_periodique(libelle, code, type_elt_bilan_periodique) VALUES ('Monde économique et professionnel', 'EPI_PRO', 1, false);
INSERT INTO notes.thematique_bilan_periodique(libelle, code, type_elt_bilan_periodique) VALUES ('Sciences, technologie et société', 'EPI_STS', 1, false);
