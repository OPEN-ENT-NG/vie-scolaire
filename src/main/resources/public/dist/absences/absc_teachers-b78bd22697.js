...
/***/ function(module, exports, __webpack_require__) {
	...
	var absc_enseignant_ctrl_1 = __webpack_require__(11);
	var mobile_panel_1 = __webpack_require__(13);
	entcore_1.ng.controllers.push(absc_enseignant_ctrl_1.absencesController);
	entcore_1.ng.directives.push(mobile_panel_1.mobilePanel);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var entcore_1 = __webpack_require__(2);
	var absc_enseignant_mdl_1 = __webpack_require__(12);
	var moment = __webpack_require__(5);
	exports.absencesController = entcore_1.ng.controller('AbsencesController', [
	    '$scope', 'route', 'model',
	    function ($scope, route, model) {
	        $scope.courss = absc_enseignant_mdl_1.vieScolaire.courss;
	        $scope.creneaus = absc_enseignant_mdl_1.vieScolaire.creneaus;
	        $scope.plages = absc_enseignant_mdl_1.vieScolaire.plages;
	        ...
	        entcore_1.template.open('absc_teacher_appel_eleves_container', '../templates/absences/absc_teacher_appel_eleves');
	        ...
	        $scope.ajouterEvenementAbsence = function (poEleve) {
	            ...
	            if (evenementAbsence === undefined) {
	                evenementAbsence = new absc_enseignant_mdl_1.Evenement();
	                ...
	                evenementAbsence.create().then(function (piEvenement) {
	                ...
	                evenementAbsence.delete().then(function () {
	        ...
	        $scope.mapToTimestamp = function (poEvenement, poMomentDebutCours) {
	            // initalisation des heures selon l'heure courante et la date du cours
	            if (poEvenement.fk_type_evt_id === $scope.oEvtType.giIdEvenementDepart) {
	                var oEvenementTimestampDepart = moment(poMomentDebutCours, $scope.format.gsFormatTimestampWithoutTimeZone).hour(poEvenement.evenement_heure_depart.split(":")[0]).minute(poEvenement.evenement_heure_depart.split(":")[1]);
	                poEvenement.evenement_timestamp_depart = oEvenementTimestampDepart.format($scope.format.gsFormatTimestampWithoutTimeZone);
	            }
	            else if (poEvenement.fk_type_evt_id === $scope.oEvtType.giIdEvenementRetard) {
	                var oEvenementTimestampArrive = moment(poMomentDebutCours, $scope.format.gsFormatTimestampWithoutTimeZone).hour(poEvenement.evenement_heure_arrivee.split(":")[0]).minute(poEvenement.evenement_heure_arrivee.split(":")[1]);
	        ...
	        $scope.lightboxAppel = function () {
	            entcore_1.template.open('lightbox', '../modules/absences/template/absc_teacher_help');
	            $scope.show.lightbox = true;
	        };
	        $scope.selectCurrentCours = function () {
	            var currentCours = $scope.courss.filter(function (cours) {
	        ...
	        $scope.detailEleveAppel = function (poEleve) {
	            ...
	            if (oEvenementRetard === undefined) {
	                oEvenementRetard = new absc_enseignant_mdl_1.Evenement();
	            ...
	            if (oEvenementDepart === undefined) {
	                oEvenementDepart = new absc_enseignant_mdl_1.Evenement();
	            ...
	            if (oEvenementIncident === undefined) {
	                oEvenementIncident = new absc_enseignant_mdl_1.Evenement();
	            ...
	            if (oEvenementObservation === undefined) {
	                oEvenementObservation = new absc_enseignant_mdl_1.Evenement();
	        ...
	        route({
	            appel: function (params) {
	                ...
	                entcore_1.template.open('main', '../templates/absences/absc_teacher_appel');
	            }
	        });
	    }
	]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Plage = (function (_super) {
	    __extends(Plage, _super);
	    function Plage() {
	...
	exports.Plage = Plage;
	var Creneau = (function (_super) {
	    __extends(Creneau, _super);
	    function Creneau() {
	        return _super.apply(this, arguments) || this;
	    }
	    return Creneau;
	}(entcore_1.Model));
	exports.Creneau = Creneau;
	var Evenement = (function (_super) {
	    __extends(Evenement, _super);
	    function Evenement() {
	        return _super.apply(this, arguments) || this;
	    }
	    Object.defineProperty(Evenement.prototype, "api", {
	        get: function () {
	            return {
	    ...
	    Evenement.prototype.create = function () {
	        var _this = this;
	        return new Promise(function (resolve, reject) {
	            entcore_1.http().postJson(_this.api.post, _this).done(function (data) {
	                resolve({ id: data.id, bool: true });
	            });
	        });
	    };
	    Evenement.prototype.update = function () {
	        var _this = this;
	        return new Promise(function (resolve, reject) {
	            entcore_1.http().putJson(_this.api.put, _this).done(function (data) {
	                resolve({ id: data.id, bool: false });
	            });
	        });
	    };
	    Evenement.prototype.save = function () {
	        var _this = this;
	        return new Promise(function (resolve, reject) {
	            if (_this.id) {
	    ...
	    Evenement.prototype.delete = function () {
	        var _this = this;
	        return new Promise(function (resolve, reject) {
	            entcore_1.http().delete(_this.api.delete + _this.id).done(function () {
	                resolve();
	            });
	        });
	    };
	...
	var AbsencePrev = (function (_super) {
	    __extends(AbsencePrev, _super);
	    function AbsencePrev() {
	        return _super.apply(this, arguments) || this;
	    }
	    return AbsencePrev;
	}(entcore_1.Model));
	exports.AbsencePrev = AbsencePrev;
	var Eleve = (function (_super) {
	    __extends(Eleve, _super);
	    function Eleve() {
	        var _this = _super.call(this) || this;
	        _this.collection(Evenement, {
	            sync: function (psDateDebut, psDateFin) {
	                entcore_1.http().getJson('/viescolaire/absences/eleve/' + _this.composer.eleve_id + '/evenements/' + psDateDebut + '/' + psDateFin).done(function (data) {
	                    _this.evenements.load(data);
	                });
	            }
	        });
	        _this.collection(Cours);
	        _this.evenementsJours = new entcore_1.Collection(Evenement);
	        _this.evenementsJours.model = _this;
	        _this.collection(Plage, {
	            sync: function (piIdAppel) {
	                // Evenements du jours
	                var otEvt = _this.evenementsJours;
	                // Liste des cours
	                var otCours = _this.courss;
	                var that = _this.plages;
	                // On copie les plages dans un tableau
	                that.load(JSON.parse(JSON.stringify(exports.vieScolaire.plages)));
	                for (var i = 0; i < that.all.length; i++) {
	                    that.all[i].evenements = new entcore_1.Collection(Evenement);
	                    that.all[i].evenements.model = that.all[i];
	                    that.all[i].evenements.composer = that.all[i].evenements.model = _this;
	                }
	                /**
	                 ...
	                 */
	                _.each(otEvt.all, function (evenement) {
	                 ...
	                 */
	                if (_this.absencePrevs.all.length > 0) {
	                    _.each(_this.absencePrevs, function (abs) {
	        ...
	        _this.collection(AbsencePrev, {
	            sync: function (psDateDebut, psDateFin) {
	                entcore_1.http().getJson('/viescolaire/absences/eleve/' + _this.composer.eleve_id + '/absencesprev/' + psDateDebut + '/' + psDateFin).done(function (data) {
	                    _this.absencePrevs.load(data);
	                });
	            }
	        });
	        return _this;
	...
	exports.Eleve = Eleve;
	var Appel = (function (_super) {
	    __extends(Appel, _super);
	    function Appel() {
	        return _super.apply(this, arguments) || this;
	    }
	    Object.defineProperty(Appel.prototype, "api", {
	        get: function () {
	            return {
	    ...
	    Appel.prototype.create = function () {
	        var _this = this;
	        return new Promise(function (resolve, reject) {
	            entcore_1.http().postJson(_this.api.post, _this).done(function (data) {
	    ...
	    Appel.prototype.update = function () {
	        var _this = this;
	        return new Promise(function (resolve, reject) {
	            entcore_1.http().putJson(_this.api.put, _this).done(function (data) {
	                if (resolve && (typeof (resolve) === 'function')) {
	...
	exports.Appel = Appel;
	var AppelElevesCollection = (function () {
	    function AppelElevesCollection() {
	        this.sync = function () {
	            var that = this;
	            entcore_1.http().getJson('/viescolaire/classe/' + this.composer.fk_classe_id + '/eleves').done(function (data) {
	    ...
	    AppelElevesCollection.prototype.loadEvenements = function () {
	        var _this = this;
	        /**
	         ...
	         */
	        entcore_1.http().getJson('/viescolaire/absences/evenement/classe/' + this.composer.fk_classe_id + '/periode/' + moment(this.composer.cours_timestamp_dt).format('YYYY-MM-DD') + '/' + moment(this.composer.cours_timestamp_dt).format('YYYY-MM-DD'))
	            .done(function (data) {
	            for (var i = 0; i < _this.all.length; i++) {
	                _this.all[i].evenementsJours.load(_.where(data, { fk_eleve_id: _this.all[i].eleve_id }));
	                _this.all[i].evenements.load(_this.all[i].evenementsJours.where({ cours_id: _this.composer.cours_id }));
	            }
	            _this.loadAbscPrev();
	        });
	    };
	    AppelElevesCollection.prototype.loadAbscPrev = function () {
	        var _this = this;
	        entcore_1.http().getJson('/viescolaire/absences/absencesprev/classe/' + this.composer.fk_classe_id + '/' + moment(this.composer.cours_timestamp_dt).format('YYYY-MM-DD') + '/' + moment(this.composer.cours_timestamp_dt).format('YYYY-MM-DD'))
	            .done(function (data) {
	            for (var i = 0; i < _this.all.length; i++) {
	                _this.all[i].absencePrevs.load(_.where(data, { fk_eleve_id: _this.all[i].eleve_id }));
	            }
	        });
	        this.loadAbscLastCours();
	    };
	    AppelElevesCollection.prototype.loadAbscLastCours = function () {
	        var _this = this;
	        entcore_1.http().getJson('/viescolaire/absences/precedentes/classe/' + this.composer.fk_classe_id + '/cours/' + this.composer.cours_id)
	            .done(function (data) {
	            _.each(data, function (absc) {
	                var eleve = this.findWhere({ eleve_id: absc.fk_eleve_id });
	                if (eleve !== undefined) {
	                    eleve.absc_precedent_cours = true;
	                }
	            });
	            _this.loadCoursClasse();
	        });
	    };
	    AppelElevesCollection.prototype.loadCoursClasse = function () {
	        var _this = this;
	        entcore_1.http().getJson('/viescolaire/' + this.composer.fk_classe_id + '/cours/' + moment(this.composer.cours_timestamp_dt).format('YYYY-MM-DD') + '/' + moment(this.composer.cours_timestamp_fn).format('YYYY-MM-DD'))
	            .done(function (data) {
	            _.each(_this.all, function (eleve) {
	                eleve.courss.load(data);
	            });
	            _this.trigger("appelSynchronized");
	        });
	    };
	    return AppelElevesCollection;
	}());
	var Cours = (function (_super) {
	    __extends(Cours, _super);
	    function Cours() {
	        var _this = _super.call(this) || this;
	        _this.cours = _this;
	        _this.appel = new Appel();
	        _this.appel.sync = function () {
	            var that = _this;
	            entcore_1.http().getJson(_this.api.getAppel + _this.cours.cours_id).done(function (data) {
	                var _this = this;
	                ...
	                if (this.id === undefined) {
	                    ...
	                    this.create().then(function (data) {
	                        _this.id = data.id;
	                    });
	                }
	            }.bind(_this.appel));
	        };
	        _this.collection(Eleve, new AppelElevesCollection());
	        return _this;
	    }
	    Object.defineProperty(Cours.prototype, "api", {
	        get: function () {
	            return {
	...
	exports.Cours = Cours;
	var VieScolaire = (function (_super) {
	    __extends(VieScolaire, _super);
	    function VieScolaire() {
	        var _this = _super.call(this) || this;
	        _this.collection(Cours, {
	            sync: function (userId, dateDebut, dateFin) {
	                if (userId !== undefined && dateDebut !== undefined && dateFin !== undefined) {
	                    entcore_1.http().getJson('/viescolaire/enseignant/' + userId + '/cours/' + dateDebut + '/' + dateFin)
	                        .done(function (data) {
	                        _this.courss.load(data);
	                    });
	                }
	            }
	        });
	        _this.collection(Plage, {
	            sync: function () {
	                ...
	                _this.plages.load(oListePlages);
	            }
	        });
	        _this.collection(Creneau, {
	            sync: function () {
	                ...
	                if (_this.courss !== undefined && _this.courss.all.length > 0) {
	                    // initialsiation heure en cours (1ère heure à placer sur les crenaux)
	                    oHeureEnCours = goHeureDebutPlage;
	                    for (var i = 0; i < _this.courss.all.length; i++) {
	                        var oCurrentCours = _this.courss.all[i];
	                        ...
	                        if (oHeureDebutCours.diff(oHeureEnCours) > 0) {
	                            ...
	                            var creneau_1 = new Creneau();
	                            creneau_1.heureDebut = oHeureEnCours.format(gsFormatHeuresMinutes);
	                            creneau_1.heureFin = oHeureDebutCours.format(gsFormatHeuresMinutes);
	                            creneau_1.cours = undefined;
	                            creneau_1.duree = oHeureDebutCours.diff(oHeureEnCours, "minute");
	                            creneau_1.style = {
	                                "height": creneau_1.duree + "px"
	                            };
	                            oListeCreneauxJson.push(creneau_1);
	                        ...
	                        if (i === (_this.courss.all.length - 1)) {
	                            ...
	                            if (goHeureFinPlage.diff(oHeureFinCours) > 0) {
	                                var creneau_2 = new Creneau();
	                                creneau_2.heureDebut = oHeureFinCours.format(gsFormatHeuresMinutes);
	                                creneau_2.heureFin = goHeureFinPlage.format(gsFormatHeuresMinutes);
	                                creneau_2.cours = undefined;
	                                creneau_2.duree = goHeureFinPlage.diff(oHeureFinCours, "minute");
	                                creneau_2.style = {
	                                    "height": creneau_2.duree + "px"
	                                };
	                                oListeCreneauxJson.push(creneau_2);
	                            }
	                        }
	                    }
	                }
	                _this.creneaus.load(oListeCreneauxJson);
	            }
	        });
	        return _this;
	    }
	    VieScolaire.prototype.sync = function () {
	        this.courss.sync();
	        this.plages.sync();
	        this.creneaus.sync();
	    };
	...
	exports.VieScolaire = VieScolaire;
	exports.vieScolaire = new VieScolaire();
	entcore_1.model.build = function () {
	    this.vieScolaire = exports.vieScolaire;
	    exports.vieScolaire.sync();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var entcore_1 = __webpack_require__(2);
	exports.mobilePanel = entcore_1.ng.directive('mobilePanel', function () {
	    return {
	        restrict: 'E',
	        transclude: true,
	        scope: {
...
/***/ }
/******/ ]);
//# sourceMappingURL=absc_teachers.js.map
//# sourceMappingURL=absc_teachers-b78bd22697.js.map
