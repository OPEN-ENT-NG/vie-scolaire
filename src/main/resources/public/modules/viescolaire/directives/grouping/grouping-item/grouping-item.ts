...
interface IGroupingItemProps {
    ...
    onAddGroupingAudienceItem: () => (grouping: Grouping, studentDivision: StudentDivision) => void;
    onDeleteGroupingAudienceItem: () => (grouping: Grouping, studentDivision: StudentDivision) => void;
}
...
class Controller implements IViewModel {
    ...
    addGroupingAudience = (grouping: Grouping, classOrGroup: Classe): void => {
        let studentDivision: StudentDivision = new StudentDivision({id: classOrGroup.id, name: classOrGroup.name});
