...
export class NiveauCompetence extends Model {
    ...
    get api () {
        return {
            POST: '/viescolaire/evaluations/maitrise/level',
            UPDATE: '/viescolaire/evaluations/maitrise/level/' + this.id,
            DELETE:'/viescolaire/evaluations/maitrise/level/' + this.id,
            MARK_USER: '/viescolaire/evaluations/maitrise/perso/use',
            UNMARK_USER:'/viescolaire/evaluations/maitrise/perso/use/' + model.me.userId
        };
    }
