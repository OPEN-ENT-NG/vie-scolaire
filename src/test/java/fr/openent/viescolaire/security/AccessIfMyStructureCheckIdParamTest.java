...
public class AccessIfMyStructureCheckIdParamTest {
    AccessIfMyStructureCheckIdParam access;
    ...
    public void setUp() throws NoSuchFieldException {
        access = new AccessIfMyStructureCheckIdParam();
    ...
    public void testAuthorize(TestContext ctx){
        map.set("id", "9af51dc6-ead0-4edb-8978-da14a3e9f49a");
