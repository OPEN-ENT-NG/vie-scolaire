...
public interface MultiTeachingService {
     ...
     * @param handler           Function handler returning data
     */
    void deleteMultiTeaching(JsonArray multiTeachingIds, boolean hasCompetences, Handler<Either<String, JsonObject>> handler);
    ...
    void updateMultiteaching(JsonArray idsMultiTeachingToUpdate, String secondTeacher, String startDate,
                             ...
                             boolean hasCompetences, Handler<Either<String,JsonArray>> handler);
