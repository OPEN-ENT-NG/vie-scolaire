...
/***/ function(module, exports, __webpack_require__) {
	...
	var eval_parent_ctl_1 = __webpack_require__(3);
	entcore_1.ng.controllers.push(eval_parent_ctl_1.evaluationsController);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var entcore_1 = __webpack_require__(2);
	var eval_parent_mdl_1 = __webpack_require__(4);
	    ...
	    function ($scope, route, $rootScope, $location) {
	        route({
	            displayReleveNotes: function (params) {
	                entcore_1.template.open('main', '../templates/evaluations/eval_parent_dispreleve');
	            }
	        });
	        $scope.searchReleve = {
	            eleve: null,
	        ...
	        if (entcore_1.model.me.type === "PERSRELELEVE") {
	            $scope.eleves = eval_parent_mdl_1.evaluations.eleves;
	        }
	        else {
	            $scope.periodes = eval_parent_mdl_1.evaluations.periodes;
	            $scope.searchReleve.eleve = entcore_1.model.me;
	        }
	        $scope.matieres = eval_parent_mdl_1.evaluations.matieres;
	        ...
	        $scope.getMatieres = function () {
	            if ($scope.searchReleve.eleve !== null) {
	                eval_parent_mdl_1.evaluations.matieres.sync($scope.searchReleve.eleve.id);
	            }
	        };
	        ...
	        $scope.chooseChild = function (idEleve) {
	            $scope.searchReleve.eleve = eval_parent_mdl_1.evaluations.eleves.findWhere({ id: idEleve });
	            $scope.getPeriodes();
	            $scope.getMatieres();
	        ...
	        $scope.calculMoyenne = function (idMatiere) {
	            ...
	            if (notes !== undefined) {
	                $scope.searchReleve.periode.calculMoyenne().then(function (moyenne) {
	                    return moyenne;
	                });
	            }
	            else {
	        ...
	        $scope.$on('syncPeriodes', function () {
	            setCurrentPeriode(entcore_1.model.me.structures[0]);
	            $scope.safeApply();
	        });
	        $scope.loadReleveNote = function () {
	            ...
	            if ($scope.searchReleve.periode !== null) {
	                if (entcore_1.model.me.type === 'PERSRELELEVE') {
	                    var eleve = eval_parent_mdl_1.evaluations.eleves.findWhere({ id: $scope.searchReleve.eleve.id });
	                    ...
	                    periode = eval_parent_mdl_1.evaluations.periodes.findWhere({ id: $scope.searchReleve.periode.id });
	        ...
	        var setCurrentPeriode = function (idEtablissement) {
	            ...
	            if (entcore_1.model.me.type === 'PERSRELELEVE') {
	                ...
	                periodes = eval_parent_mdl_1.evaluations.periodes;
	            }
	        ...
	        if (entcore_1.model.me.type === 'ELEVE') {
	            $scope.getPeriodes();
	            eval_parent_mdl_1.evaluations.matieres.sync(entcore_1.model.me.userId);
	        }
	        else if (entcore_1.model.me.type === 'PERSRELELEVE') {
	            eval_parent_mdl_1.evaluations.eleves.one('sync', function () {
	                if (eval_parent_mdl_1.evaluations.eleves.all.length > 1) {
	                    entcore_1.template.open('lightboxContainer', '../templates/evaluations/eval_parent_dispenfants');
	                    $scope.showNoteLightBox.bool = true;
	                }
	                else {
	                    $scope.searchReleve.eleve = eval_parent_mdl_1.evaluations.eleves.all[0];
	                    $scope.getPeriodes();
	                    $scope.getMatieres();
	                }
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Eleve = (function (_super) {
	        ...
	        _this.collection(Periode, {
	            sync: function () {
	                if (_this.id !== undefined) {
	                    entcore_1.http().getJson(_this.api.get).done(function (perdiodes) {
	                        this.periodes.load(perdiodes);
	                    });
	                }
	            }
	        });
	        _this.periodes.on('sync', function () {
	    ...
	    Object.defineProperty(Eleve.prototype, "api", {
	        get: function () {
	            return {
	                get: '/viescolaire/evaluations/periodes?idEtablissement=' + entcore_1.model.me.structures[0]
	            };
	        },
	        enumerable: true,
	        configurable: true
	...
	var Periode = (function (_super) {
	    ...
	    function Periode() {
	        ...
	        _this.collection(Devoir, {
	            sync: function (structureId, userId) {
	                entcore_1.http().getJson('/viescolaire/evaluations/devoirs/periode/' + _this.id + '?idEtablissement=' + structureId + '&idUser=' + userId)
	                    .done(function (devoirs) {
	                    _this.devoirs.load(devoirs);
	                });
	            }
	        });
	        return _this;
	    }
	    Object.defineProperty(Periode.prototype, "api", {
	        get: function () {
	            return {
	    ...
	    Periode.prototype.getReleve = function (idPeriode, idUser) {
	        location.replace('/viescolaire/evaluations/releve/pdf?idEtablissement=' + entcore_1.model.me.structures[0] + '&idPeriode=' + idPeriode + '&idUser=' + idUser);
	    };
	    Periode.prototype.calculMoyenne = function () {
	        var _this = this;
	        return new Promise(function (resolve, reject) {
	            if (_this.devoirs.all.length > 0) {
	                entcore_1.http().postJson(_this.api.calculMoyenne, { notes: _this.devoirs.all }).done(function (res) {
	                    if (_.has(res, "moyenne")) {
	                        _this.moyenne = res.moyenne;
	    ...
	    Evaluations.prototype.sync = function () {
	        if (entcore_1.model.me.type === 'PERSRELELEVE') {
	            this.collection(Eleve, {
	                sync: function () {
	                    entcore_1.http().get('/viescolaire/evaluations/enfants?userId=' + entcore_1.model.me.userId).done(function (eleves) {
	                        var listeEleves = [];
	            ...
	            this.collection(Periode, {
	                sync: function () {
	                    entcore_1.http().getJson('/viescolaire/periodes?idEtablissement=' + entcore_1.model.me.structures[0]).done(function (periodes) {
	                        this.load(periodes);
	                    }.bind(this));
	                }
	            });
	        ...
	        this.matieres.sync = function (idEleve) {
	            if (idEleve !== undefined) {
	                entcore_1.http().getJson('/viescolaire/matieres/eleve/' + idEleve).done(function (matieres) {
...
/***/ }
/******/ ]);
//# sourceMappingURL=eval_parents.js.map
//# sourceMappingURL=eval_parents-bcb6de2d41.js.map
