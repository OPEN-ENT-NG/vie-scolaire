...
(
	...
	CONSTRAINT pk_niveau_final PRIMARY KEY (id_periode, id_eleve, id_competence, id_matiere),
	...
	ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT competence_niveau_final UNIQUE (id_periode, id_eleve, id_competence, id_matiere)
	);