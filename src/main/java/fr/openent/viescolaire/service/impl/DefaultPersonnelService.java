 ...
 */
public class DefaultPersonnelService extends SqlCrudService implements PersonnelService {
    public DefaultPersonnelService() {
    ...
    public void getEnseignantEtablissement(String idEtablissement, Handler<Either<String, JsonArray>> handler) {
        ...
        .append("FROM "+ Viescolaire.ABSC_SCHEMA +".personnel WHERE personnel.id_etablissement = ?::uuid ")
